        ...
        <div className="grid grid-cols-2 gap-10 lg:grid-cols-12 lg:gap-16">
                ...
                menuOne.map((item, index) => (
                  <li>
                    <a href="#" className='text-default-300 text-base transition-all hover:text-white'>
                      <i data-lucide="gauge-circle" className="me-2 inline-block h-4 w-4"></i>
                      {item}
                    </a>
                  </li>
                ))
          ...
          <div className="col-span-2 lg:col-span-6">
              <div className="bg-primary/20 rounded-xl">
                <div className="p-10">
                  <h6 className="mb-4 text-xl text-white">
                    NewsLetter
                  </h6>
                  <p className="text-default-200 mb-6 text-base font-medium">
                    Signup and recevied the lastest tips 
                  </p>
                  ...
                  <form onSubmit={handleSubmit} className='mb-6 space-y-2'>
                    ...
                    <div className="relative">
                      ...
                      <button type='submit' disabled={state.submitting} className='hover:bg-primary-hover hover:border-primary-hover border-primary bg-primary end-[6px] absolute top-[6px] inline-flex h-9 items-center justify-center gap-2 rounded-md px-6 text-white transition-all'>
                        Subscribe
                      </button>
                    </div>
                  </form>
