      ...
      <div className={`flex w-full flex-col`}>
        {
          reversedNotifications.map((n, idx) => {
            <Notification key={`${n.message}${idx}`} type={n.type} message={n.message} description={n.description} txid={n.txid}
            onHide={() => {
...
const Notification = ({type, message, description, txid, onHide}) => {
  ...
  return (
    <div className="bg-bkg-1 pointer-events-atuo z-50 mx-4 mt-2 mb-12 w-full max-w-sm overflow-hidden rounded-md bg-[#0a1023] p-2 shadow-loadGetInitialProps right-1">
      <div className="p-4">
